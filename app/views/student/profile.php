...
<head>
    ...
    <title><?php echo e($appName); ?> - My Profile</title>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="post" action="<?php echo e(url('?page=student.profile')); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm mb-3">
                <div class="card-body">
                    ...
                    <p class="mb-0"><strong>Login:</strong> <?php echo ((int) $student['is_active'] === 1) ? 'Active' : 'Inactive'; ?></p>
                </div>
            </div>

            <div class="card shadow-sm">
                <div class="card-body">
                    <h2 class="h6 text-muted">Current Enrollment</h2>
                    ...
                    <?php else: ?>
                        <p class="text-muted mb-0">No enrollment found yet.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
