...
<head>
    ...
    <title><?php echo e($appName); ?> - Student Announcements</title>
...
<div class="container py-4" style="max-width: 1100px;">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <p class="text-muted mb-0">Messages relevant to students and your class.</p>
        </div>
        <div class="d-flex gap-2">
            <a href="<?php echo e(url('?page=student.notifications')); ?>" class="btn btn-outline-warning">Notifications</a>
    ...
    <div class="row g-3">
        ...
        <?php if (empty($announcements)): ?>
            <div class="col-12">
                <div class="alert alert-info mb-0">No announcements available for students.</div>
            </div>
        <?php endif; ?>
    </div>
</div>
