...
<head>
    ...
    <title><?php echo e($appName); ?> - Teacher Announcements</title>
...
<div class="container py-4" style="max-width: 1100px;">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <p class="text-muted mb-0">Messages relevant to teachers and your classes.</p>
        </div>
        <div class="d-flex gap-2">
            <a href="<?php echo e(url('?page=teacher.notifications')); ?>" class="btn btn-outline-warning">Notifications</a>
    ...
    <div class="row g-3">
        ...
        <?php if (empty($announcements)): ?>
            <div class="col-12">
                <div class="alert alert-info mb-0">No announcements available for teachers.</div>
            </div>
        <?php endif; ?>
    </div>
</div>
