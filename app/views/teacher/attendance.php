...
<head>
    ...
    <title><?php echo e($appName); ?> - Teacher Attendance</title>
...
<div class="container py-4" style="max-width: 1200px;">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="h4 mb-1">Teacher Attendance</h1>
            <p class="text-muted mb-0">Mark attendance only for your assigned classes.</p>
        </div>
        <div class="d-flex gap-2">
            <a href="<?php echo e(url('?page=teacher.dashboard')); ?>" class="btn btn-outline-secondary">Back</a>
            <a href="<?php echo e(url('?page=admin.attendance.daily')); ?>" class="btn btn-outline-dark">Daily View</a>
        </div>
    </div>
    ...
    <div class="row g-4">
        <div class="col-lg-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form method="get" action="<?php echo e(url('?page=teacher.attendance')); ?>">
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <?php if (!$class): ?>
                        <div class="alert alert-warning mb-0">Select one of your assigned classes to load the register.</div>
                    <?php elseif (empty($students)): ?>
                        <div class="alert alert-info mb-0">No active students found in this class.</div>
                    <?php else: ?>
                        <form method="post" action="<?php echo e(url('?page=teacher.attendance')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mt-3 d-flex gap-2">
                                ...
                                <a href="<?php echo e(url('?page=teacher.attendance.daily&class_id=' . (int) $selectedClassId . '&date=' . urlencode($selectedDate))); ?>" class="btn btn-outline-secondary">Daily Report</a>
                            </div>
                        </form>
                    <?php endif; ?>
                </div>
