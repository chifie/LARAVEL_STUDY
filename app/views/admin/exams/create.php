...
<div class="container py-4" style="max-width: 1100px;">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <p class="text-muted mb-0">Choose a class-subject assignment, then create the exam.</p>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="post" action="<?php echo e(url('?page=admin.exams.create')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="row g-3">
                            ...
                            <?php foreach ($assignments as $assignment): ?>
                                <option value="<?php echo (int) $assignment['id']; ?>" <?php echo old('assignment_id') == $assignment['id'] ? 'selected' : ''; ?>>
                                    ...
                                    <?php if (!empty($assignment['teacher_name'])): ?>
                                        | <?php echo e($assignment['teacher_name']); ?>
                                    <?php endif; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="exam_name" class="form-control" placeholder="Midterm Exam" value="<?php echo e(old('exam_name')); ?>" required>
                    </div>
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    <a href="<?php echo e(url('?page=admin.exams')); ?>" class="btn btn-outline-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
