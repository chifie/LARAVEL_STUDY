...
<div class="container py-4" style="max-width: 1300px;">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(url('?page=admin.exams.results&exam_id=' . (int) $exam['id'])); ?>" class="btn btn-outline-dark">View Results</a>
    ...
    <?php else: ?>
        <form method="post" action="<?php echo e(url('?page=admin.exams.marks&exam_id=' . (int) $exam['id'])); ?>">
            <?php echo csrf_field(); ?>
